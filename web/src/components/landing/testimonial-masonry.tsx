...
const TESTIMONIALS: T[] = [
  ...
  { quote: "We A/B two hooks per episode. SnapClip gives us both cuts instantly.", name: "Marco D.", role: "Podcast network", handle: "@signal.fm", avatar: "https://picsum.photos/seed/av12/96/96", metric: "A/B every ep" },
