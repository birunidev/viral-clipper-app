...
`04 Speaker` — **Next** (03 done). `03` completed 2026-08-31 — `silenceDetector -30dB d0.3 → tightness strong/candidate + fillerDetector EN/ID um/anu→0.96 + falseStart stub + videoAnalysis silences/fillers`.
