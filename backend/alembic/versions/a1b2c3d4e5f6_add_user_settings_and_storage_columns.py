...
def upgrade() -> None:
    ...
    if not conn.dialect.has_table(conn, "user_settings"):
        op.create_table(
            "user_settings",
    ...
    if not any(i["name"] == "ix_user_settings_user_id" for i in insp.get_indexes("user_settings")):
